    ...
    private fun getLocation(){
        ...
        location.addOnSuccessListener {
            if(it!=null){
                late = it.latitude
                longe = it.longitude
                //findViewById<TextView>(R.id.Lattitute_value).text = late.toString()
                //findViewById<TextView>(R.id.Longitude_value).text = longe.toString()
                weatherTask().execute()
            }
        }
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                findViewById<TextView>(R.id.eyerange_val).text =  visibility
